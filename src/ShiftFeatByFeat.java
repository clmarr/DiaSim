...
public class ShiftFeatByFeat extends ShiftByFeat{
	...
	// Constructors follow: 
	public ShiftFeatByFeat(HashMap<String,Integer> ftInds, String targSpecs, String destSpecs)
	{	super(); initialize(ftInds, targSpecs, destSpecs); 	}
		
	public ShiftFeatByFeat(HashMap<String,Integer> ftInds, String targSpecs, String destSpecs, boolean attendToPseudos)
	{	super(attendToPseudos); initialize(ftInds, targSpecs, destSpecs); 	}
	
	public ShiftFeatByFeat(HashMap<String,Integer> ftInds, String targSpecs, String destSpecs, 
			List<RestrictPhone> priors, List<RestrictPhone> postrs)
	{	super(priors,postrs); initialize(ftInds, targSpecs, destSpecs); 	}
	
	public ShiftFeatByFeat(HashMap<String,Integer> ftInds, String targSpecs, String destSpecs, 
			boolean attendToPseudos,List<RestrictPhone> priors, List<RestrictPhone> postrs)
