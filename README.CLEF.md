...
BaseCLEF was constructed as a baseline to represent the relative chronology of regular sound change represented in the seminal work of Pope 1934, which continues to be used as the baseline to be built from among Anglophone work on French diachronic phonology (Short 2013), while it is to be acknowledged that equally suitable potential baselines could be found in works by other authors in other languages such as French and German (e.g. that of Fouché, Bourciez, Rheinfelder, Richter, etc.).
...
Changes were only made if they would lead to improvements, with the rest of the cascade held constant, and given that the rest of the cascade was inevitably a modified or unmodified part of Pope 1934's hypothesized relative chronology, it is quite reasonable to assume that this process would be predisposed to remain within certain areas within the hypothesis space of possible relative chronologies for the development of regional Latin into French, without a specific impetus to explore many other areas that nevertheless may have merited exploration. 
